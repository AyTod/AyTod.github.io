...
;define("xvector-assignment/pods/components/line-graph/component", ["exports"], function (_exports) {
  ...
  var _default = Ember.Component.extend({
    ...
    actions: {
      ...
      changePlotTitle() {
        this.set("plotTitle", event.target.value);
        this.graphComponent();
      },

      changeBatchSize() {
        this.set('batchSize', event.target.value);
        this.graphComponent();
      }
