...
define("xvector-assignment/tests/lint/app.lint-test", [], function () {
  ...
  QUnit.test('pods/add-csv/route.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'pods/add-csv/route.js should pass ESLint\n\n');
  });
...
define("xvector-assignment/tests/lint/templates.template.lint-test", [], function () {
  ...
  QUnit.test('xvector-assignment/pods/add-csv/template.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'xvector-assignment/pods/add-csv/template.hbs should pass TemplateLint.\n\n');
  });
